...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        actualLabel = results_dic[key][0]
        classifiedLabel = results_dic[key][1]
        comparison = results_dic[key][2]
        actualDog = results_dic[key][3]
        classifiedDog = results_dic[key][4]
        ...
        if actualDog == classifiedDog:
            if actualDog == 1:
                results_stats_dic['n_correct_dogs'] += 1
            else:
                results_stats_dic['n_correct_notdogs'] += 1
        
        if actualDog == 1 and comparison == 1:
